...
export default function AnswerAnalysis({ question }: AnswerAnalysisProps) {
  ...
  return (
    <div className="relative mt-4 p-4 rounded-md bg-i-ivory">
      {/* 닫기 버튼을 오른쪽 상단에 배치 */}
      <button
      ...
      >
        {/* 닫기 버튼 아이콘 (예시로 X 아이콘) */}
        <span className="text-xl mr-2 text-i-darkblue">x</span>
      </button>

      {/* 답변 분석 내용 */}
      <div className="flex gap-6">
        {/* 왼쪽: 7:4 비율의 영상이 들어갈 자리 */}
        <div className="w-7/12 aspect-[7/4] bg-gray-400 rounded-md">
        ...
        {/* 오른쪽: 글 영역 */}
        <div className="w-5/12 relative mr-2">
          ...
          <p className="">이번 질문에 대한 감정 분석 결과, 
