            ...
            <div className="w-full self-stretch flex justify-start items-center gap-5 ">
              {specifiedDone ? (
                ...
                <Button
                  ...
                  variant={'primary'}
                  className="relative w-full self-stretch px-10 py-7 rounded-[40px] justify-start text-left whitespace-nowrap
                 after:content-[''] after:absolute after:inset-0 after:rounded-[40px] after:pointer-events-none
                 after:transition-colors hover:after:bg-black/10"
                >
                  오늘의 질문에
              ...
              <Button
                ...
                variant="primary"
                className="relative bg-grayscale-gray80 px-10 py-7 rounded-[40px] justify-start text-left whitespace-nowrap
               after:content-[''] after:absolute after:inset-0 after:rounded-[40px] after:pointer-events-none
