    ...
    <ModalCard hasBorder={false}>
      <div className="flex flex-col justify-start items-start gap-10">
        <div className="flex flex-col gap-3">
          <Text as="div" variant="title01">아직 속한 집이 없어요.</Text>
          <Text as="div" variant="body03" className='text-grayscale-gray60'>집을 생성하거나, 등록된 집에 참여할 수 있어요.</Text>
          
        </div>
        <div className="flex flex-col item-center gap-5 justify-center self-stretch">
          <CustomCard onClick={() => setStep(1)} className="bg-primary-primary">
            <div className="gap-3">
